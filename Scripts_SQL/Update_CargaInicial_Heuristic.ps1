...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            -- Para separar NP de Item correctamente, busquemos si existe la combinacion exacta en LIQ_Formulas
            -- o usemos el heuristico: si el ultimo guion deja mas de 4 caracteres, podria no ser un item.
            -- Mejor aun, validar contra LIQ_Formulas:
            ...
            BEGIN
                ...
                -- Verificamos si existe en Formulas
                ...
                ELSE
                BEGIN
                    -- Fallback en caso de que no lo encuentre por alguna razon (e.g. fue borrado pero todavia en UI)
                    SET @BaseNP = @posNP;
                    SET @BaseItem = @posItem;
                END
            END
